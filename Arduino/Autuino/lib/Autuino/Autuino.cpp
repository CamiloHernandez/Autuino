...
Autuino::Autuino(int Pin_Motor_A1, int Pin_Motor_A2,  int Pin_Motor_B1, int Pin_Motor_B2):
...
void Autuino::writeMotor(char Motor, bool Velocidad, bool Sentido){
  if(Motor == 'A'){
    if(Sentido == true){
  ...
  digitalWrite(_PinSalida,Velocidad);
